...
The current public result set covers **71 complete models**, **10 THOR reports**, and **189 expert-classified findings**. Models are compared against human expert ground truth and are evaluated on both classification quality and operational usefulness.
...
**Shown:** top 10 / 44 matched models. **Matched:** 44 / 71 complete models.
...
**Shown:** top 10 / 62 matched models. **Matched:** 62 / 71 complete models.
...
**Shown:** top 10 / 53 matched models. **Matched:** 53 / 71 complete models.
